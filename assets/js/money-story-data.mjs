...
export const homepageStory = {
  ...
  chapters: [
    ...
    { id: 'share', title: '“What do I still owe?”', description: 'Share a PDF with Alex: every entry and the balance.', date: 'May 22', balance: 160, covered: 340, repaid: 180, rows: entries.slice(0, 4), step: 'Share' },
