...
test("money-owed hero leads to a separate first-balance setup module", async () => {
  ...
  for (const copy of [
    ...
    "Add one person",
    "For example, add Alex, who owes you money.",
    "Record the amount",
    "Record the $120 Alex owes you and what it was for.",
    "Log a repayment",
    "When Alex pays back $30, log the repayment. The app shows $90 still owed.",
